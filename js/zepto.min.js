...
!function (t, e) {
  ...
  var e = function () {
    ...
    r.fn = {
      ...
      parents: function (t) {
        for (var e = [
        ], n = this; n.length > 0; ) n = r.map(n, function (t) {
...
(function ($, undefined) {
  ...
  $.fn.anim = function (properties, duration, ease, callback, delay) {
    ...
    if (duration > 0) {
      this.bind(endEvent, wrappedCallback)      // transitionEnd is not always firing on older Android phones
...
(function ($, undefined) {
  ...
  function anim(el, speed, opacity, scale, callback) {
    if (typeof speed == 'function' && !callback) callback = speed,
    speed = undefined
    var props = {
      opacity: opacity
    }
